...
export default function ProductCard({ product, disableAnimations = false }: ProductCardProps) {
  ...
  const containerClass = "group relative bg-white dark:bg-dark-800 rounded-lg border border-neutral-200 dark:border-dark-700 overflow-hidden hover:shadow-lg dark:hover:shadow-dark-900/50 transition-all duration-300 cursor-pointer min-h-[280px] sm:min-h-[320px]";
