      ...
      >
        ...
        <div className="relative aspect-square overflow-hidden bg-neutral-100 dark:bg-dark-700">
          ...
          <motion.button
            ...
            className={`absolute top-3 right-3 w-8 h-8 rounded-full flex items-center justify-center transition-colors ${isWishlisted
        ...
        <div className="p-4">
          ...
          {/* Product Name */}
          <h3 className="font-semibold text-neutral-900 dark:text-white mb-2 truncate group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors" title={product.name}>
            {product.name}
          </h3>
